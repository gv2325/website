...
export type Layout47Props = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const Layout47 = (props: Layout47Props) => {
...
export const Layout47Defaults: Layout47Props = {
  tagline: "Tagline",
